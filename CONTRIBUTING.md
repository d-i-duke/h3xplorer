...
- Look at open issues tagged with ["help wanted"](https://github.com/d-i-duke/h3xplorer/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) and ["good first issue"](https://github.com/d-i-duke/h3xplorer/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
- Look at the [contributing guide in our documentation](https://d-i-duke.github.io/h3xplorer/contributing)

## Licensing

Copyright (c) 2025 h3xplorer developers & contributors listed in AUTHORS.md.
By contributing to h3xplorer, i.e. through opening a pull request, you represent that your contributions are your own original work and that you have the right to license them, and you agree that your contributions are licensed under the GPL-v3.

## Reporting bugs and requesting features

You can open an issue on GitHub to report bugs or request new h3xplorer features.
Follow these links to submit your issue:

- [Report bugs or other problems while running h3xplorer](https://github.com/d-i-duke/h3xplorer/issues/new?template=BUG-REPORT.yml).
  If reporting an error, please include a full traceback in your issue.

- [Request features that h3xplorer does not already include](https://github.com/d-i-duke/h3xplorer/issues/new?template=FEATURE-REQUEST.yml).

- [Report missing or inconsistent information in our documentation](https://github.com/d-i-duke/h3xplorer/issues/new?template=DOCS.yml).

- [Any other issue](https://github.com/d-i-duke/h3xplorer/issues/new).

## Submitting changes

Look at the [development guide in our documentation](https://d-i-duke.github.io/h3xplorer/contributing) for information on how to get set up for development.
...
1. On GitHub, create a new [pull request](https://github.com/d-i-duke/h3xplorer/pull/new/main) from the feature branch.
...
- Bump the version number in `src/h3xplorer/__init__.py`
...
- Update `src/h3xplorer/__init__.py` to the next version appended with `.dev0`, in preparation for the next main commit.
